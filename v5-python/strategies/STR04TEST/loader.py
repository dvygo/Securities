"""STR04TEST beginning-of-day loader: python -m strategies --strategy=str04test
...
premarket.sources.databento_src.VENUE_CONFIGS (XNAS->EQUS.MINI,
XCBO->OPRA.PILLAR, XCME->GLBX.MDP3), key via premarket.config's per-exchange
...
from premarket.sources.databento_src import VENUE_CONFIGS
